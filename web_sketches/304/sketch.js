// space-filling grid of skewed-quad "Units" — fills the canvas right-to-left,
// bottom-to-top; noLoop once full.
...
function draw() {
  // caption (drawn fresh each frame so it stays readable)
  fill(255);
  noStroke();
  textAlign(CENTER);
  textSize(100);
  text('304--', width / 3, height / 2);
