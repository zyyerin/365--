...
(function(w) {
    ...
    */
    let canvas_width = 400; //Needs to be a multiple of the resolution value below.
    let canvas_height = 400; //This too.

    let resolution = 100; //Width and height of each cell in the grid.

    let pen_size = 40; //Radius around the mouse cursor coordinates to reach when stirring
    ...
    let speck_count = 10000; //This determines how many particles will be made.
